      ...
      <ScrollView contentContainerStyle={styles.scrollContent} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.listContainer}>
          ...
          <TouchableOpacity 
            style={styles.card} 
            activeOpacity={0.7}
            onPress={() => handleOpenDetail({ nombre: 'Bujía de Iridio', codigo: 'AUTO-091', fecha: '29/09/2023' })}
          >
          ...
          <TouchableOpacity 
            style={styles.card}
            activeOpacity={0.7}
            onPress={() => handleOpenDetail({ nombre: 'Filtro de Aceite', codigo: 'AUTO-044', fecha: '15/08/2023' })}
          >
            <View style={styles.cardIndicator} />
            <View style={styles.cardContent}>
              <View style={styles.cardIconContainer}>
          ...
          <TouchableOpacity 
            style={styles.card}
            activeOpacity={0.7}
            onPress={() => handleOpenDetail({ nombre: 'Pastillas de Freno', codigo: 'AUTO-212', fecha: '02/05/2023' })}
          >
            <View style={styles.cardIndicator} />
            <View style={styles.cardContent}>
              <View style={styles.cardIconContainer}>
